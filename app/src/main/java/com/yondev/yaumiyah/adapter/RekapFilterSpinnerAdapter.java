...
public class RekapFilterSpinnerAdapter extends BaseAdapter {
	private ArrayList<String> data;
	private Context c;
	private static LayoutInflater inflater = null;

	public RekapFilterSpinnerAdapter(Context c, ArrayList<String> data)
	{
		this.c = c;
		this.data = data;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ViewHolder holder;
        if(convertView==null){
            vi = inflater.inflate(R.layout.filter_rekap_spinner_item, null);
