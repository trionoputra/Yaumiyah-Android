...
/**
 * Created by ThinkPad on 5/9/2017.
 */
...
public class FlowLayout extends ViewGroup {
    ...
    public int clickedId = R.mipmap.ic_salat_default;
    public int clickedIds = R.id.imgSalat;
    private void onClickChild()
    {
        this.post(new Runnable() {
            ...
            public void run() {
                ...
                RelativeLayout wp  = (RelativeLayout) FlowLayout.this.getChildAt(0);
                wp.setBackgroundResource(R.drawable.border_layout_green);
                wp.getChildAt(0).setEnabled(false);

                for(int i= 0;i < FlowLayout.this.getChildCount();i++)
                {
                    RelativeLayout wrapper  = (RelativeLayout)FlowLayout.this.getChildAt(i);
                    if(wrapper.getTag() instanceof String)
                        wrapper.setTag(getResources().getIdentifier((String)wrapper.getTag(), "mipmap",FlowLayout.this.getContext().getPackageName()));
                    ...
                    wrapper.setOnClickListener(new OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            RelativeLayout lastWrapper  = (RelativeLayout) findViewById(clickedIds);

                            lastWrapper.setBackgroundResource(R.drawable.border_layout);
                            ImageView lastimg = (ImageView)lastWrapper.getChildAt(0);
                            ...
                            clickedId = (Integer)wrapper.getTag();
                            clickedIds = wrapper.getId();
                        }
                    });
                }
            }
    ...
    private boolean wajib = false;

    public boolean isWajib() {
        return wajib;
    }

    public void setWajib(boolean wajin) {
        this.wajib = wajin;
    }
